    ...
    try {
      ...
      const transformedProjects = (updatedProjects as any[]).map((project: any) => {
        ...
        return {
          ...
          client: project.client,
          location: project.location || 'TBD',
          equipmentCount: project.equipment_count || project.equipmentCount || (project.equipment?.length || 0),
          activeEquipment: project.active_equipment || 0,
          progress: project.progress || 0,
          status: project.status || 'active',
          manager: project.manager || 'TBD',
...
We have prepared a Recommendation Letter template (Word document) for your convenience. Please download it using the link below, fill in your company details, provide your feedback, sign the document, and send it back to us.

📎 Download Recommendation Letter Template:
Click here to download: ${publicUrl}

(You can click on the link above to download the Word file)
...
Note: Please download the Recommendation Letter template using the link above, fill in the details, sign it, and send it back to us.`;
      ...
      toast({
        title: "Email Opened",
        description: `Recommendation letter template uploaded. Download link added to email.`,
      });
    } catch (error) {
...
We have prepared the Recommendation Letter template (Word document) again for your convenience. Please download it using the link below, fill in your company details, provide your feedback, sign the document, and send it back to us.
                ...
                {loading ? (
                  ...
                  return (
                    <div 
                      ...
                      className={`bg-white rounded-xl shadow-[0_2px_8px_rgba(0,0,0,0.08),0_1px_3px_rgba(0,0,0,0.04)] border transition-all duration-300 overflow-hidden group cursor-pointer flex flex-col h-[650px] ${
                      isOverdue 
