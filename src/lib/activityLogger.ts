...
// Equipment logging
export const logEquipmentCreated = async (projectId: string, equipmentId: string, equipmentType: string, tagNumber: string) => {
  await logActivity({
    projectId,
    equipmentId,
...
export const logEquipmentUpdated = async (projectId: string, equipmentId: string, equipmentType: string, tagNumber: string, changes: Record<string, { old: any; new: any }>) => {
...
export const logEquipmentDeleted = async (projectId: string, equipmentId: string, equipmentType: string, tagNumber: string) => {
  await logActivity({
    projectId,
    equipmentId,
